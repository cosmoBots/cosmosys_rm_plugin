...
for my_issue in my_doc_issues+my_project_issues:
    ...
    symlink_path = img_dir + my_issue.subject+"_"+"h.gv.svg"
    ...
    if (True):
        ...
        symlink_path = img_dir + my_issue.subject+"_"+"d.gv.svg"
...
with open(reporting_dir + '/doc/reqs.json', 'w') as outfile:  
...
success = execute_js('./plugins/cosmosys/assets/javascripts/lib/launch_carbone.js',reporting_dir)
print(success)
...
with open('./plugins/cosmosys/assets/javascripts/reqtree/src/reqtreedata.json', 'w') as outfile:  
